        ...
        <n-card style="max-width: 40vw;">
            <n-space>
                ...
                <n-space vertical>
                    <n-h3>编号</n-h3>
                    <n-input
                    v-model:value="controlStore.Id"></n-input>
                </n-space>
            </n-space>
            <n-h3>演示数据集</n-h3>
            <n-space>
            ...
            <n-h3>操作数据集</n-h3>
            <n-space>
                <n-button @click="loadDataset('/datasets/cars.json')">Cars</n-button>
...
<script setup>
import { NButton, NIcon, NModal, NCard, NSpace, NH3, NDivider, NInput } from "naive-ui";
