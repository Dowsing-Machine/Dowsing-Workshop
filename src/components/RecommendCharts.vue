<template>
    <n-card style="width: fit-content;margin:5px;max-width:100%" hoverable>
        ...
        <template #header-extra>
            <n-button v-if="!collectionStore.inCollection(vegalite)" text class="header_button" @click="addCollection">
                <n-icon>
                    <star12-regular />
                </n-icon>
            </n-button>
...
<script setup>
import { NCard, NButton, NIcon, NTag,NSpace } from 'naive-ui';
import ChartRawVue from './ChartRaw.vue';
import { defineProps, computed } from 'vue-demi';
import { QueryStore } from '../store/QueryStore';
import {CollectionStore} from '../store/CollectionStore';

import { Tag24Filled, Square20Filled, FullScreenMaximize24Filled, ZoomIn24Regular, PointScan24Filled, Star12Regular,Star12Filled, ArrowUp16Filled } from "@vicons/fluent"
